...
$.ajax({
    type :"GET",
    async : true,
    url : " http://www.easy-mock.com/mock/5a18e0754a055229cab8995c/example_1511579765289?jsonp_param_name=callback",
    dataType : "jsonp",
    ...
    success:function(data){
        ...
        //菜品移入凸显效果
        $("#Food_content").children("div").children("img").mouseover(function (){
            $(this).velocity({"scaleX":"1.1","scaleY":"1.1"},500);
            $(this).parent("div").siblings().css("opacity","0.65");
        }).mouseout(function(){
            $(this).stop().velocity({"scaleX":"1","scaleY":"1"},300);
            $(this).parent("div").siblings($(this)).css({"color":"white","opacity":"1"});
        });
        ...
        $("#banner").children("span").click(function(){
            $("#nav").css("left",(-$(this).index())*$(".nav_li").outerWidth()+"px");
            $("#banner").children("span").css("backgroundColor","aliceblue").eq($(this).index()-4).css("backgroundColor","blue");
        })
    },
...
function toT(){
    ...
    y++;
    $("#team_content_main").velocity({"top":-y*($(".team_content_div").outerHeight())+"px"},350,"linear");
...
$(".team_content_div").on({"mouseover":function(){
    clearInterval(timer1);
    $(".team_content_div").css({"backgroundColor":"#212121"}).eq($(this).index()).css({"backgroundColor":"#4e4e4e"})
