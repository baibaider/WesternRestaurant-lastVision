...
$.ajax({
    type :"GET",
    async : true,
    url : "http://www.easy-mock.com/mock/5a18e4664a055229cab89e6e/foodComment?jsonp_param_name=callback",
    dataType : "jsonp",
...
$.ajax({
    type :"GET",
    async : true,
    url : "http://www.easy-mock.com/mock/5a18e4664a055229cab89e6e/bannerList?jsonp_param_name=callback",
    dataType : "jsonp",
...
var aAdd=oSection.getElementsByTagName("input");
oSection.appendChild(oComment);
aAdd[0].onclick=function(){
...
var oUl=document.getElementById("add_comments");
aAdd[1].onclick=function(){
    if(oComment!=""&&oComment!="添加评论..."){
        var oLi = document.createElement("li");
        oLi.innerHTML = oComment.value;
       oUl.appendChild(oLi);
       oComment.value="添加评论...";
    }
}
